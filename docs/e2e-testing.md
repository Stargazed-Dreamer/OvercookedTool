...
- 推荐样本：使用 `OvercookedTool.Tests/Helpers/SyntheticSampleFactory.cs` 现场生成的合成样本目录（虚假 SteamID64 `76561198000000002`），仅用于只读冒烟。
...
| 导入样本 | 通过 | 加载合成样本目录（虚假 SteamID64 `76561198000000002`），识别 `Oc2`、目录名密钥有效、好友号 `39734274` |
